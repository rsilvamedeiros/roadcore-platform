...
export const accessScreens: readonly AccessScreen[] = [
  ...
  { id: "content", name: "Conteúdo do site", description: "Páginas, publicações, mídia, campanhas e navegação pública.", path: "/admin/content", surface: "admin", requiredPermission: "content.read" },
...
export const adminRoleTemplates: readonly AdminRoleTemplate[] = [
  ...
  { id: "sales", name: "Comercial", description: "Clientes, leads, negociações, anúncios e propostas.", surface: "admin", permissions: ["dashboard.read", "crm.customer.read", "crm.customer.create", "crm.customer.update", "crm.lead.read", "crm.lead.create", "crm.lead.update", "asset.listing.read", "financial.proposal.read", "financial.proposal.create", "report.commercial.read", "content.read", "content.update"] },
